...
class VimChatScope:
    ...
    def init(self):
        ...
        vim.command('let s:hasVars = vimchat#main#CheckVars()')
    ...
    def toggleBuddyList(self):
        ...
        commands = """
        setlocal foldtext=vimchat#main#FoldText()
        setlocal nowrap
        ...
        nnoremap <buffer> <silent> R :py VimChat.refreshBuddyList()<CR>
        exe 'nnoremap <buffer> <silent> <Leader>n /{'.'{{ (<CR>'
...
if exists('g:autoloaded_vimchat_main')
    finish
endif
let g:autoloaded_vimchat_main = 1

autocmd! VIMLeave * :VimChatStop

set switchbuf=usetab

fu! vimchat#main#CheckVars() "{{{
    ...
    if !exists('g:vimchat_xa_cmd')
      let g:vimchat_xa_cmd = 'xa'
    endif
    if !exists('g:vimchat_away_cmd')
      let g:vimchat_away_cmd = 'away'
    endif
...
function! vimchat#main#FoldText() "{{{
